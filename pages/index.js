...
//               <p><strong>Insurance Card Serial:</strong> {sale.axaInsuranceCardSerial}</p>
//               <p><strong>Remark:</strong> {sale.customerRemark}</p>
//               <p><strong>Device Model:</strong> {sale.deviceModel}</p>
//             </div>
//           </li>
//         ))}
//       </ul>
...
//         <h1 className="text-2xl font-bold">Canvasser App</h1>
//         <FaInfoCircle
//           className="text-blue-500 text-2xl cursor-pointer"
//           onClick={() => setShowTutorial(true)}
//         />
...
//             <p>Current Status: {isCheckedIn ? 'Checked In' : 'Checked Out'}</p>
//           </div>
//           {isCheckedIn ? (
//             <>
//               <BranchDropdown selectedBranch={selectedBranch} setSelectedBranch={setSelectedBranch} />
